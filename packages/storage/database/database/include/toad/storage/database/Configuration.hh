...
struct Configuration
{
    ...
    {
return "Configuration: {host: {"+host+"}, port: {"+std::to_string(port)+
          "}, database_name: {"+databaseName+"}, user: {"+user+"}}";
    }
...
template <> struct fmt::formatter<toad::storage::database::Configuration> : ostream_formatter {}; // NOLINT